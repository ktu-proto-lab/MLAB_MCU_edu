...
create_clock -add -name clk_in -period 8.00 -waveform {0 4} [get_ports { clk_in }];

## FT2232H 60 MHz CLKOUT

#set_property -dict { PACKAGE_PIN Y6    IOSTANDARD LVCMOS33 } [get_ports { ft_clk     }]; #IO_L13N_T2_MRCC_13 Sch=rpio_15_r
set_property -dict { PACKAGE_PIN Y7    IOSTANDARD LVCMOS33 } [get_ports { ft_clk }]; #IO_L13P_T2_MRCC_13 Sch=rpio_24_r      Pin18?
...
#set_property -dict { PACKAGE_PIN Y18   IOSTANDARD LVCMOS33 } [get_ports { ft_data[0] }]; #IO_L17P_T2_34 Sch=ja_p[1]
#set_property -dict { PACKAGE_PIN Y19   IOSTANDARD LVCMOS33 } [get_ports { ft_data[1] }]; #IO_L17N_T2_34 Sch=ja_n[1]
#set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS33 } [get_ports { ft_data[2] }]; #IO_L7P_T1_34 Sch=ja_p[2]
#set_property -dict { PACKAGE_PIN Y17   IOSTANDARD LVCMOS33 } [get_ports { ft_data[3] }]; #IO_L7N_T1_34 Sch=ja_n[2]
#set_property -dict { PACKAGE_PIN U18   IOSTANDARD LVCMOS33 } [get_ports { ft_data[4] }]; #IO_L12P_T1_MRCC_34 Sch=ja_p[3]
#set_property -dict { PACKAGE_PIN U19   IOSTANDARD LVCMOS33 } [get_ports { ft_data[5] }]; #IO_L12N_T1_MRCC_34 Sch=ja_n[3]
#set_property -dict { PACKAGE_PIN W18   IOSTANDARD LVCMOS33 } [get_ports { ft_data[6] }]; #IO_L22P_T3_34 Sch=ja_p[4]
#set_property -dict { PACKAGE_PIN W19   IOSTANDARD LVCMOS33 } [get_ports { ft_data[7] }]; #IO_L22N_T3_34 Sch=ja_n[4]

##PmodB

#set_property -dict { PACKAGE_PIN W14   IOSTANDARD LVCMOS33 } [get_ports { ft_rxf_n  }]; #IO_L8P_T1_34 Sch=jb_p[1]
#set_property -dict { PACKAGE_PIN Y14   IOSTANDARD LVCMOS33 } [get_ports { ft_txe_n  }]; #IO_L8N_T1_34 Sch=jb_n[1]
#set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33 } [get_ports { ft_rd_n   }]; #IO_L1P_T0_34 Sch=jb_p[2]
#set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33 } [get_ports { ft_wr_n   }]; #IO_L1N_T0_34 Sch=jb_n[2]
#set_property -dict { PACKAGE_PIN V16   IOSTANDARD LVCMOS33 } [get_ports { ft_oe_n   }]; #IO_L18P_T2_34 Sch=jb_p[3]
#set_property -dict { PACKAGE_PIN W16   IOSTANDARD LVCMOS33 } [get_ports { ft_siwu_n }]; #IO_L18N_T2_34 Sch=jb_n[3]
...
set_property -dict { PACKAGE_PIN Y19   IOSTANDARD LVCMOS33 } [get_ports { ft_data[1] }]; #IO_L17N_T2_34 Sch=rpio_05_r            Pin29
...
set_property -dict { PACKAGE_PIN F19   IOSTANDARD LVCMOS33 } [get_ports { ft_txe_n }]; #IO_L12N_T1_MRCC_34 Sch=rpio_08_r         Pin24
set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { ft_rxf_n }]; #IO_L21N_T3_DQS_13 Sch=rpio_09_r          Pin21
set_property -dict { PACKAGE_PIN V8    IOSTANDARD LVCMOS33 } [get_ports { ft_siwu_n }]; #IO_L15P_T2_DQS_13 Sch=rpio_10_r         Pin19
set_property -dict { PACKAGE_PIN W10   IOSTANDARD LVCMOS33 } [get_ports { ft_rd_n }]; #IO_L16P_T2_13 Sch=rpio_11_r               Pin23
set_property -dict { PACKAGE_PIN B20   IOSTANDARD LVCMOS33 } [get_ports { ft_data[2] }]; #IO_L1N_T0_AD0N_35 Sch=rpio_12_r        Pin32
set_property -dict { PACKAGE_PIN W8    IOSTANDARD LVCMOS33 } [get_ports { ft_data[3] }]; #IO_L15N_T2_DQS_13 Sch=rpio_13_r        Pin33
...
set_property -dict { PACKAGE_PIN Y8    IOSTANDARD LVCMOS33 } [get_ports { ft_data[4] }]; #IO_L14N_T2_SRCC_13 Sch=rpio_19_r       Pin35
set_property -dict { PACKAGE_PIN A20   IOSTANDARD LVCMOS33 } [get_ports { ft_data[6] }]; #IO_L2N_T0_AD8N_35 Sch=rpio_20_r        Pin38
set_property -dict { PACKAGE_PIN Y9    IOSTANDARD LVCMOS33 } [get_ports { ft_data[7] }]; #IO_L14P_T2_SRCC_13 Sch=rpio_21_r       Pin40
...
set_property -dict { PACKAGE_PIN F20   IOSTANDARD LVCMOS33 } [get_ports { ft_wr_n }]; #IO_L15N_T2_DQS_AD12N_35 Sch=rpio_25_r     Pin22
set_property -dict { PACKAGE_PIN W9    IOSTANDARD LVCMOS33 } [get_ports { ft_data[5] }]; #IO_L16N_T2_13 Sch=rpio_26_r            Pin37
set_property -dict { PACKAGE_PIN Y16   IOSTANDARD LVCMOS33 } [get_ports { ft_oe_n }]; #IO_L7P_T1_34 Sch=rpio_sd_r                Pin27
set_property -dict { PACKAGE_PIN Y17   IOSTANDARD LVCMOS33 } [get_ports { ft_data[0] }]; #IO_L7N_T1_34 Sch=rpio_sc_r             Pin28
