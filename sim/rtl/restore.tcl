...
#
#      xrun -sv -access +rw +gui -timescale 1ns/1ns -clean +define+RANDOM_NUMBER=230 -define FUNCTIONAL -f files.f ../../tb/sobel_full_tb.sv -s -input /home/la_v9/mlab/MLAB_MCU_edu/sim/rtl/restore.tcl
#
