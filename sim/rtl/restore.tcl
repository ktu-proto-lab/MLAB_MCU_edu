...
#
#      xrun -sv -access +rw +gui -timescale 1ns/1ns -clean +define+RANDOM_NUMBER=135 -define FUNCTIONAL -f files.f ../../tb/compress_full_tb.sv -s -input restore.tcl
#
