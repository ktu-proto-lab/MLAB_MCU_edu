...
#
#      xrun -sv -access +rw +gui -timescale 1ns/1ns -clean +define+RANDOM_NUMBER=187 -define FUNCTIONAL -f files.f ../../tb/gpio_tb.sv -input restore.tcl
#
