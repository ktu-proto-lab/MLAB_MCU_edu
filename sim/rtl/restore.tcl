...
#
#      xrun -sv -access +rw +gui -timescale 1ns/1ns -clean +define+RANDOM_NUMBER=37 -define FUNCTIONAL -f files.f ../../tb/sobel_full_tb.sv -s -input restore.tcl
#
