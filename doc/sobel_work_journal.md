...
[revisit] `camera_fifo` behavioral sim files placed in `fpga/IP/`; to be regenerated targeting XC7Z020 before hardware bring-up
...
4. Develop a testbench that exercises the subsystem in isolation
...
- `bram.sv`: 32-bit wide, word-addressed (19,200 words, QVGA frame); `ram_style=block` under `FPGA_Implementation`
