...
## 2026-07-07
### Did
- Shorted CN2-21 and CN2-22 to make sure SIWU is always 1. This makes loopback work but there is always an extra 0 in the beginning. 
- Chased the sync-245 byte errors to the end: 1 byte lost per 512 B USB packet, at ANY data rate.

## 2026-07-08
### Did
- Fable generated `fpga/rtl/ftdi_245fifo_top_txfix.v` to unpop the last byte per 512 B packet and send it on the next packet. More detailed description for the problem and solution in `ftdi_test/README.md`