...
---------------------------------------------------------------------------
Description     : SQI Serial Flash Memory, SST26WF040B 512KB Memory
Revision Status : 1.0
---------------------------------------------------------------------------
...
`timescale 1ns / 10 ps
module sst26wf040b(SCK,SIO,CEb);
...
reg [31:0] error_cnt;	// count timing errors
	...
	defparam I0.Ksize = 512;  //Size of memory in Kilo bytes
	defparam I0.Msize = 0;				// Size of memory in Mega bites. I.E. 8-bit field size, use S080=1, S016=2, S032=4
	defparam I0.ADDR_MSB=18;			// most significant address bit, 32Mb=21,16Mb=20, 8Mb=19, 4Mb=18;
	defparam I0.Memory_Capacity = 8'h54;		// ID read memory size 32M=52,16M=51,8M=58, JEDEC read value
	// change below values if you need non-default values on POR
	defparam I0.WLLD_value = 24'h00_0000;	// init WLLD protection register non-volitale, default to all 0's
