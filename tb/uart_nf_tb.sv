...
`ifdef LOG_OUTPUT
    ...
    parameter file="../../tb/log/uart_nf.log";
...
`ifdef LOG_OUTPUT
        ...
        $fwrite(fd, "[  TRACE]: using code from the sw/ibex/test/uart_no_fifo test project\n");
        $fwrite(fd, "[   INFO]: output of the uart rx:\n\n");
`endif
